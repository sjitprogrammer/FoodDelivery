...
public class CartDB {
    ...
    public ArrayList<FeaturedModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FeaturedModel> playerList =  new ArrayList<FeaturedModel>();

        for(String jObjString : objStrings){
            FeaturedModel player  = gson.fromJson(jObjString,  FeaturedModel.class);
    ...
    public void putListObject(String key, ArrayList<FeaturedModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FeaturedModel player: playerList){
